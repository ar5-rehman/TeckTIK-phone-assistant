	package com.tech.tecktik.youtubePlayer;
    ...
    public class YoutubeConnector {
        ...
        public static final String KEY = "AIzaSyCiPxuLufpK9DNnGeFoMqW91pol6wR_ioc";
        ...
        public static final String SHA1 = "65:D1:F9:7C:3A:5D:D0:D4:D9:94:54:D2:0E:34:FB:63:30:CB:48:5C";
        ...
        public List<com.tech.tecktik.youtubePlayer.VideoItem> search(String keywords) {
            ...
            try {
                ...
                List<com.tech.tecktik.youtubePlayer.VideoItem> items = new ArrayList<com.tech.tecktik.youtubePlayer.VideoItem>();
        ...
        private static List<com.tech.tecktik.youtubePlayer.VideoItem> setItemsList(Iterator<SearchResult> iteratorSearchResults) {

            //temporary list to store the raw data from the returned results
            List<com.tech.tecktik.youtubePlayer.VideoItem> tempSetItems = new ArrayList<>();
            ...
            while (iteratorSearchResults.hasNext()) {
                ...
                if (rId.getKind().equals("youtube#video")) {
                    ...
                    com.tech.tecktik.youtubePlayer.VideoItem item = new com.tech.tecktik.youtubePlayer.VideoItem();
